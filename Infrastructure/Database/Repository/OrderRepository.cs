...
namespace webapi.Infrastructure.Database.Repository
{
    public class OrderRepository : IOrderRepository //added 4:45PM 1/24/2023
    {
        ...
        {
            var entityOrder = await FindIdOrder(orderId);
        ...
        //private async Task<Entities.CartItem> FindIdCartItem(Guid id, OrderModel order) //added 4:55PM 1/24/2023
        //{
        //    var foundCartItem = await _context.CartItems.FirstOrDefaultAsync(r=>r.OrderPrimaryId == order.OrderId);
